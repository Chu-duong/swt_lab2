...
public class EmailService {
  ...
  public void sendHtmlEmail(String email, String name, Long id) throws MessagingException {
    ...
    String htmlContent =
        "<h1>Hello "
            ...
            + "<h1>Confirm account: "
            + email
            + " from Happy Programing</h1>"
            + "<a href='http://localhost:8080/verify/"
            + id
            + "'>Click here to confirm infomation</a>";
  ...
  public void sendResetPassword(String email, String name, String password)
